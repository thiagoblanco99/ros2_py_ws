...
class Metaclass_Navigate_Goal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('robo_clase22')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_Navigate_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from robo_clase22.action import Navigate
...
class Navigate_SendGoal_Request(metaclass=Metaclass_Navigate_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'robo_clase22/Navigate_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['robo_clase22', 'action'], 'Navigate_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from robo_clase22.action._navigate import Navigate_Goal
...
class Metaclass_Navigate_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robo_clase22.action.Navigate_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from robo_clase22.action import _navigate
...
class Navigate_SendGoal(metaclass=Metaclass_Navigate_SendGoal):
    from robo_clase22.action._navigate import Navigate_SendGoal_Request as Request
    from robo_clase22.action._navigate import Navigate_SendGoal_Response as Response
...
class Navigate_GetResult_Response(metaclass=Metaclass_Navigate_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'robo_clase22/Navigate_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['robo_clase22', 'action'], 'Navigate_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from robo_clase22.action._navigate import Navigate_Result
...
class Metaclass_Navigate_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robo_clase22.action.Navigate_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Navigate_GetResult(metaclass=Metaclass_Navigate_GetResult):
    from robo_clase22.action._navigate import Navigate_GetResult_Request as Request
    from robo_clase22.action._navigate import Navigate_GetResult_Response as Response
...
class Metaclass_Navigate_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'robo_clase22.action.Navigate_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Navigate_FeedbackMessage(metaclass=Metaclass_Navigate_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'robo_clase22/Navigate_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['robo_clase22', 'action'], 'Navigate_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from robo_clase22.action._navigate import Navigate_Feedback
...
class Navigate(metaclass=Metaclass_Navigate):
    ...
    from robo_clase22.action._navigate import Navigate_Goal as Goal
    # The result message defined in the action definition.
    from robo_clase22.action._navigate import Navigate_Result as Result
    # The feedback message defined in the action definition.
    from robo_clase22.action._navigate import Navigate_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from robo_clase22.action._navigate import Navigate_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from robo_clase22.action._navigate import Navigate_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from robo_clase22.action._navigate import Navigate_FeedbackMessage as FeedbackMessage
