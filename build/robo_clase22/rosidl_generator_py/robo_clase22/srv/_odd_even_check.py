...
class Metaclass_OddEvenCheck(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from robo_clase22.srv import _odd_even_check
...
class OddEvenCheck(metaclass=Metaclass_OddEvenCheck):
    from robo_clase22.srv._odd_even_check import OddEvenCheck_Request as Request
    from robo_clase22.srv._odd_even_check import OddEvenCheck_Response as Response
