...
static const _OddEvenCheck_Request_type_support_symbol_names_t _OddEvenCheck_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robo_clase22, srv, OddEvenCheck_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robo_clase22, srv, OddEvenCheck_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robo_clase22, srv, OddEvenCheck_Request)() {
  return &::robo_clase22::srv::rosidl_typesupport_c::OddEvenCheck_Request_message_type_support_handle;
}
...
static const _OddEvenCheck_Response_type_support_symbol_names_t _OddEvenCheck_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robo_clase22, srv, OddEvenCheck_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robo_clase22, srv, OddEvenCheck_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robo_clase22, srv, OddEvenCheck_Response)() {
  return &::robo_clase22::srv::rosidl_typesupport_c::OddEvenCheck_Response_message_type_support_handle;
}
...
static const _OddEvenCheck_type_support_symbol_names_t _OddEvenCheck_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robo_clase22, srv, OddEvenCheck)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robo_clase22, srv, OddEvenCheck)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, robo_clase22, srv, OddEvenCheck)() {
  return &::robo_clase22::srv::rosidl_typesupport_c::OddEvenCheck_service_type_support_handle;
}
