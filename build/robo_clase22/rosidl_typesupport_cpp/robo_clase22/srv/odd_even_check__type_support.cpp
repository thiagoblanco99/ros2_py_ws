...
static const _OddEvenCheck_Request_type_support_symbol_names_t _OddEvenCheck_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robo_clase22, srv, OddEvenCheck_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robo_clase22, srv, OddEvenCheck_Request)),
  }
};
...
{
  return &::robo_clase22::srv::rosidl_typesupport_cpp::OddEvenCheck_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robo_clase22, srv, OddEvenCheck_Request)() {
  return get_message_type_support_handle<robo_clase22::srv::OddEvenCheck_Request>();
}
...
static const _OddEvenCheck_Response_type_support_symbol_names_t _OddEvenCheck_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robo_clase22, srv, OddEvenCheck_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robo_clase22, srv, OddEvenCheck_Response)),
  }
};
...
{
  return &::robo_clase22::srv::rosidl_typesupport_cpp::OddEvenCheck_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robo_clase22, srv, OddEvenCheck_Response)() {
  return get_message_type_support_handle<robo_clase22::srv::OddEvenCheck_Response>();
}
...
static const _OddEvenCheck_type_support_symbol_names_t _OddEvenCheck_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robo_clase22, srv, OddEvenCheck)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robo_clase22, srv, OddEvenCheck)),
  }
};
...
{
  return &::robo_clase22::srv::rosidl_typesupport_cpp::OddEvenCheck_service_type_support_handle;
}
