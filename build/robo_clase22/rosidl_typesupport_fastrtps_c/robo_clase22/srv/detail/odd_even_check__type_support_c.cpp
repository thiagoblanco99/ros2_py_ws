...
#include "robo_clase22/srv/detail/odd_even_check__rosidl_typesupport_fastrtps_c.h"
...
using _OddEvenCheck_Request__ros_msg_type = robo_clase22__srv__OddEvenCheck_Request;
...
size_t get_serialized_size_robo_clase22__srv__OddEvenCheck_Request(
  const void * untyped_ros_message,
...
static uint32_t _OddEvenCheck_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robo_clase22__srv__OddEvenCheck_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robo_clase22
size_t max_serialized_size_robo_clase22__srv__OddEvenCheck_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _OddEvenCheck_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robo_clase22__srv__OddEvenCheck_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robo_clase22, srv, OddEvenCheck_Request)() {
...
using _OddEvenCheck_Response__ros_msg_type = robo_clase22__srv__OddEvenCheck_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robo_clase22
size_t get_serialized_size_robo_clase22__srv__OddEvenCheck_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _OddEvenCheck_Response__ros_msg_type * ros_message = static_cast<const _OddEvenCheck_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_robo_clase22__srv__OddEvenCheck_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robo_clase22
size_t max_serialized_size_robo_clase22__srv__OddEvenCheck_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _OddEvenCheck_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robo_clase22__srv__OddEvenCheck_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robo_clase22, srv, OddEvenCheck_Response)() {
...
// already included above
// #include "robo_clase22/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "robo_clase22/srv/odd_even_check.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robo_clase22, srv, OddEvenCheck)() {
